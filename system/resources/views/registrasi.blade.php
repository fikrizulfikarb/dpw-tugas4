...
<head>
    ...
    <!-- Font Icon -->
    <link rel="stylesheet" href="{{ url('public/signup') }}/fonts/material-icon/css/material-design-iconic-font.min.css">

    <!-- Main css -->
    <link rel="stylesheet" href="{{ url('public/signup') }}/css/style.css">
</head>
<body>
    ...
    <!-- JS -->
    <script src="{{ url('public/signup') }}/vendor/jquery/jquery.min.js"></script>
    <script src="{{ url('public/signup') }}/js/main.js"></script>
